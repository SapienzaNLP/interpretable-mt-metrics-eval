...
echo "Starting run_everything_wmt23_all_lps_fully_comparable.sh script execution..."
...
#zh-en
python scripts/py/rank_metrics.py --include-human --include-outliers --new-metrics --average-by item --n-processes 12 --gold-score-threshold -4
...
python scripts/py/rank_metrics.py --include-human --include-outliers --new-metrics --average-by item --n-processes 12 --gold-score-threshold -1
...
#en-de
python scripts/py/rank_metrics.py --include-human --include-outliers --new-metrics --average-by item --n-processes 12 --gold-score-threshold -4 --lp en-de
...
python scripts/py/rank_metrics.py --include-human --include-outliers --new-metrics --average-by item --n-processes 12 --gold-score-threshold -1 --lp en-de
...
#he-en
python scripts/py/rank_metrics.py --ref-to-use refB --include-human --include-outliers --new-metrics --average-by item --n-processes 12 --gold-score-threshold -4 --lp he-en
...
python scripts/py/rank_metrics.py --ref-to-use refB --include-human --include-outliers --new-metrics --average-by item --n-processes 12 --gold-score-threshold -1 --lp he-en
